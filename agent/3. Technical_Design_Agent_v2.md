...
- Dùng GDI+ chụp màn hình, nội suy về 1280x720. **Tối ưu băng thông:** Sử dụng `MD5` băm khung hình hiện tại so với khung hình trước, bỏ qua truyền tải nếu màn hình tĩnh. Đồng bộ bằng `SemaphoreSlim`.
